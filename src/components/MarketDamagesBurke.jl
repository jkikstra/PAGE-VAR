...
@defcomp MarketDamagesBurke begin
    ...
    rgdp_per_cap_MarketRemainGDP_sum = Variable(unit = "\$/person") # for analysis / debugging / code analysis
    rgdp_per_cap_MarketRemainGDP_ann_sum = Variable(unit = "\$/person") # for analysis / debugging / code analysis
    ...
    i_burke_regionalimpact_ann = Variable(index = [year, region], unit = "degreeC") # NEW - for annual version
    i1log_impactlogchange_ann = Variable(index = [year, region]) # NEW - for annual version
    ...
    isat_per_cap_ImpactperCapinclSaturationandAdaptation_sum = Variable(unit = "\$/person") # NEW - for annual version MC
        # origin in this component, no need for in-component interpolation, as they are calculated in run_timestep
    ...
    isat_per_cap_ImpactperCapinclSaturationandAdaptation_ann_sum = Variable(unit = "\$/person") # NEW - for annual version MC
