...
@defcomp NonMarketDamages begin
    ...
    imp_actualreduction = Parameter(index=[time, region], unit= "%")
        # from AdaptiveCostsNonEconomic: needs in-component interpolation
    atl_adjustedtolerableleveloftemprise_ann = Variable(index=[year,region], unit="degreeC") # NEW - for annual version
    imp_actualreduction_ann = Variable(index=[year, region], unit= "%") # NEW - for annual version
    ...
    i_regionalimpact_ann = Variable(index=[year, region], unit="degreeC") # NEW - for annual version

    #impact Parameters from MarketDamagesBurke
    ...
    rcons_per_cap_MarketRemainConsumption_ann = Parameter(index=[year, region], unit = "\$/person") # NEW - for annual version --> from MarketDamagesBurke
    rgdp_per_cap_MarketRemainGDP_ann = Parameter(index=[year, region], unit = "\$/person") # NEW - for annual version --> from MarketDamagesBurke
    ...
    rcons_per_cap_NonMarketRemainConsumption_ann = Variable(index=[year, region], unit = "\$/person") # NEW - for annual version
    rgdp_per_cap_NonMarketRemainGDP_ann = Variable(index=[year, region], unit = "\$/person") # NEW - for annual version
    iref_ImpactatReferenceGDPperCap_ann = Variable(index=[year, region], unit="%") # NEW - for annual version
    igdp_ImpactatActualGDPperCap_ann = Variable(index=[year, region], unit="%") # NEW - for annual version
    isat_ImpactinclSaturationandAdaptation_ann = Variable(index=[year, region], unit="\$") # NEW - for annual version
    isat_per_cap_ImpactperCapinclSaturationandAdaptation_ann = Variable(index=[year, region], unit="\$/person") # NEW - for annual version
    isat_per_cap_ImpactperCapinclSaturationandAdaptation_ann_sum_nonmarket = Variable(unit = "\$/person") # NEW - for annual version MC
    rgdp_per_cap_NonMarketRemainGDP_sum = Variable(unit = "\$/person") # for analysis / debugging / code analysis
    rgdp_per_cap_NonMarketRemainGDP_ann_sum = Variable(unit = "\$/person") # for analysis / debugging / code analysis
