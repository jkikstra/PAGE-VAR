...
function buildpage(m::Model, scenario::String, use_permafrost::Bool=true, use_seaice::Bool=false)
    ...
    connect_param!(m, :MarketDamages => :rtl_realizedtemperature_ann, :ClimateTemperature => :rtl_realizedtemperature_ann) # annual regional temperatures.
    ...
    connect_param!(m, :MarketDamagesBurke => :rtl_realizedtemperature_ann, :ClimateTemperature => :rtl_realizedtemperature_ann) # annual regional temperatures.
    ...
    connect_param!(m, :NonMarketDamages => :rtl_realizedtemperature_ann, :ClimateTemperature => :rtl_realizedtemperature_ann) # annual regional temperatures.
    connect_param!(m, :NonMarketDamages => :rgdp_per_cap_MarketRemainGDP_ann, :MarketDamagesBurke => :rgdp_per_cap_MarketRemainGDP_ann) # annual per capita remaining GDP.
    connect_param!(m, :NonMarketDamages => :rcons_per_cap_MarketRemainConsumption_ann, :MarketDamagesBurke => :rcons_per_cap_MarketRemainConsumption_ann) # annual per capita remaining GDP consumption.
    ...
    connect_param!(m, :Discontinuity => :rgdp_per_cap_NonMarketRemainGDP_ann, :NonMarketDamages => :rgdp_per_cap_NonMarketRemainGDP_ann) # annual per capita remaining GDP
    connect_param!(m, :Discontinuity => :rt_g_globaltemperature_ann, :ClimateTemperature => :rt_g_globaltemperature_ann) # annual global temperatures
    connect_param!(m, :Discontinuity => :rcons_per_cap_NonMarketRemainConsumption_ann, :NonMarketDamages => :rcons_per_cap_NonMarketRemainConsumption_ann) # annual per capita remaining GDP consumption.
    ...
    connect_param!(m, :EquityWeighting => :rcons_percap_dis_ann, :Discontinuity => :rcons_per_cap_DiscRemainConsumption_ann) # anunal per capita remaining GDP after discontinuity damages (and after all other damages)
...
function initpage(m::Model)
    set_param!(m, :ClimateTemperature, :y_year_ann, collect(2015:2300)) # set annual timestep parameter
    set_param!(m, :MarketDamages, :y_year_ann, collect(2015:2300)) # set annual timestep parameter
    set_param!(m, :MarketDamagesBurke, :y_year_ann, collect(2015:2300)) # set annual timestep parameter
    set_param!(m, :NonMarketDamages, :y_year_ann, collect(2015:2300)) # set annual timestep parameter
    set_param!(m, :Discontinuity, :y_year_ann, collect(2015:2300)) # set annual timestep parameter
    set_param!(m, :EquityWeighting, :y_year_ann, collect(2015:2300)) # set annual timestep parameter
    p = load_parameters(m)
    p["y_year_0"] = 2015.
...
function getpage(scenario::String="NDCs", use_permafrost::Bool=true, use_seaice::Bool=false)
    m = Model()
    set_dimension!(m, :year, collect(2015:2300)) # annual timestep dimension
